    ...
    try {
        ...
        if (fs.existsSync(packageJsonPath)) {
            ...
            if (packageJson.productName) {
                electron_1.app.name = packageJson.productName;
            }
            else if (packageJson.name) {
                electron_1.app.name = packageJson.name;
            }
            appPath = packagePath;
        }
        try {
            const filePath = Module._resolveFilename(packagePath, module, true);
            electron_1.app._setDefaultAppPaths(appPath || path.dirname(filePath));
        }
        catch (e) {
...
function showErrorMessage(message) {
    ...
    electron_1.dialog.showErrorBox('Error launching app', message);
    process.exit(1);
}
