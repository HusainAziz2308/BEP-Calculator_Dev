...
const phaseCreator = function (index) {
  ...
  li.innerHTML =
    `<li class="flex-col my-3">
      <div class="flex flex-grow justify-between">
        <p class="text-xs leading-loose font-bold uppercase text-green-500 px-2">Tahap Ke ${index + 1}:</p>
      ...
      <div class="flex pb-2">
        <input id="phase-input" type="number" value="${data.sells[index]}" class="pl-1 bg-transparent focus:outline-none border-b-2 border-gray-400 hover:border-teal-300 focus:border-teal-500 mx-1 flex-grow w-1 text-blue-500" placeholder="Tahap Penjualan">
